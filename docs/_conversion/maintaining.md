...
When we convert your Web Builder integration we make it availble through our new web based builder tool.  However, the new platform offers you two ways of developing and maintaing your Zapier integration.  In addition to the UI based tool, you may choose to use the Zapier Command Line Interface (CLI).  This is an SDK you install in your local development environments.  It allows you to build your integration soley in code.  This is the best option for professional developers, teams, projects with non-trivial amounts of custom code, and/or projects that require the use of 3rd party modules or advanced platform features.
