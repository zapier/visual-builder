...
The most immediate and important difference you’ll notice is that the new platform introduces the concept of [versions](https://platform.zapier.com/manage/versions-ui).  
...
Field names and structure of the Bundle is slightly different between the legacy Web Builder and the new platform.  Please see the [Bundle docs](https://platform.zapier.com/reference/cli-docs#bundle-object) for details.
...
More information on moving to the CLI [here](https://platform.zapier.com/manage/export-integration)
