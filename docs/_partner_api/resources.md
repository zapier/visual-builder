...
curl -H "Authorization: Bearer {token}" \
  -L "https://api.zapier.com/v1/zaps?&params__board=BOARD_ID"
```
...
```bash
curl -H "Authorization: Bearer {token}" \
  -L "https://api.zapier.com/v1/zap-templates/me?client_id=${client_id}"
```
...
```bash
curl -H "Authorization: Bearer {token}" \
  -L "https://api.zapier.com/v1/zap-templates?client_id=${client_id}&apps=mailchimp"
```
...
```bash
curl -H "Authorization: Bearer {token}" \
  -L "https://api.zapier.com/v1/zap-templates/me?client_id=${client_id}&status=draft"
```
...
```bash
curl -H "Authorization: Bearer {token}" \
  -L "https://api.zapier.com/v1/zap-templates/me?client_id=${client_id}&limit=20&offset=20"
```
